...
class VOnboardingItemReady:UIView
{
    ...
    convenience init(controller:COnboardingItemReady)
    {
        ...
        label.text = NSLocalizedString("VOnboardingItemReady_label", comment:"")
        ...
        button.setTitle(NSLocalizedString("VOnboardingItemReady_button", comment:""), forState:UIControlState.Normal)
